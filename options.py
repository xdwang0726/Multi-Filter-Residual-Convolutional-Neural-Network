...
# model
parser.add_argument("-model", type=str, choices=['CNN', 'MultiCNN', 'ResCNN', 'MultiResCNN', 'MultiResCNN_GCN', 'MultiSeResCNN_GCN', 'RNN_GCN', 'DCAN', 'MultiResCNN_atten'], default='MultiSeResCNN_GCN')
