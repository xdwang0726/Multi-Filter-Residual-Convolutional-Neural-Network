...
class MultiResCNNLabelAtten(nn.Module):

    def __init__(self, args, Y, dicts, cornet_dim=1000, n_cornet_blocks=2):
        super(MultiResCNNLabelAtten, self).__init__()
...
class MultiResCNNMaskedLabelAtten(nn.Module):

    def __init__(self, args, Y, dicts, cornet_dim=1000, n_cornet_blocks=2):
        super(MultiResCNNMaskedLabelAtten, self).__init__()
...
class MultiRatesDilatedResCNN(nn.Module):

    def __init__(self, args, Y, dicts, cornet_dim=1000, n_cornet_blocks=2):
        super(MultiRatesDilatedResCNN, self).__init__()
...
class MultiFilterDilatedResCNN(nn.Module):

    def __init__(self, args, Y, dicts, cornet_dim=1000, n_cornet_blocks=2):
        super(MultiFilterDilatedResCNN, self).__init__()
...
class MultiDilatedCNN(nn.Module):
    def __init__(self, args, Y, dicts, use_res=True):
        ...
        self.gcn = LabelNet(args.embedding_size, args.embedding_size*self.filter_num, args.embedding_size)
